...
f_build_huaweicloud(){
  ...
  directory='~/.terraform.d/plugins/local-registry/huaweicloud/huaweicloud/0.0.1/linux_amd64'
  ...
  then
    mkdir -p $directory
    chmod -R 777 '~/.terraform.d/plugins/local-registry/huaweicloud/'
  fi
...
f_build_flexibleengine(){
  ...
  directory='~/.terraform.d/plugins/local-registry/flexibleengine/flexibleengine/0.0.1/linux_amd64'
  ...
  then
    mkdir -p $directory
    chmod -R 777 '~/.terraform.d/plugins/local-registry/flexibleengine/'
  fi
...
f_build_g42cloud(){
  ...
  directory='~/.terraform.d/plugins/local-registry/g42cloud/g42cloud/0.0.1/linux_amd64'
  ...
  then
    mkdir -p $directory
    chmod -R 777 '~/.terraform.d/plugins/local-registry/g42cloud/'
  fi
